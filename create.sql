...
ALTER TABLE Matches ADD CONSTRAINT PK_Dates1 PRIMARY KEY (dates);
ALTER TABLE Matches ADD CONSTRAINT PK_Home_Team1 PRIMARY KEY (home_team);    
ALTER TABLE Matches ADD CONSTRAINT PK_Away_Team1 PRIMARY KEY (away_team);
